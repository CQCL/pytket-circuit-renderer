  ...
  computed: {
    ...
    commandArgs () {
      ...
      this.command.args.forEach((arg, pos) => {
        ...
        argDetails[arg] = {
          ...
          order: order, // index of arg in the display order
        }
      });
      return {
        details: argDetails,
    ...
    adjustedBounds () {
      ...
      if (this.renderOptions.condenseCBits) {
        ...
        for (let regName of this.overlappingCondensedRegisters.names) {
    ...
    indexedArgDetails () {
      ...
      this.registerOrder.forEach((arg, order) => {
        ...
        argDetails[arg] = {
          ...
          order: order, // index of this arg in the display order
          flags: {
